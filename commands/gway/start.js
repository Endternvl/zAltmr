...
module.exports = {
  ...
  message.channel.send("Do You Want Any Bonus Enteries? if yes, type `yes`. if no, type `no`");
          ...
          await message.channel
            ...
            .then(async rolentery => {
              ...
              message.channel.send(
                `✅ Epic! Now, **${rolename}** will have **${BonusEntries}** Extra Enteries`
              );
            });
        }
      } else {
  ...
  await client.giveawaysManager.start(giveawayChannel, {
    ...
    messages: {
      ...
      inviteToParticipate: `React with 🎉 to participate! good luck!`,
  ...
  message.channel.send(`${message.author.username} Giveaway started in ${giveawayChannel}!`);
  }
}
